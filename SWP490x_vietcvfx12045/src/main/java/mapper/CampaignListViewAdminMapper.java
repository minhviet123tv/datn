...
public class CampaignListViewAdminMapper implements RowMapper <CampaignListViewAdmin>{
	
	 public CampaignListViewAdmin mapRow(ResultSet rs, int rowNum) throws SQLException {
		 	
		 	CampaignListViewAdmin campaign = new CampaignListViewAdmin(); //remaining_date, campaign_end_date
		 	
		 	//Lấy giá trị các cột của các bảng: Trong câu truy vấn của CampaignJDBCTemplate đến CSDL. Và truyền, gán vào đối tượng CampaignListViewAdmin để sử dụng
